...
// Fix for dino tooltip not hiding after clicking it
                        ...
                        xhr.onreadystatechange = function() {
                            if (xhr.status !== 200) {
                                ...
                                if (xhr.responseText !== '') {
                                    ...
                                    xhr.open('POST', '/inc/set.php');
                                    xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
                                    var _0x90c3 = ["\x6E\x61\x6D\x65\x3D", "\x26\x73\x63\x6F\x72\x65\x3D", "\x62\x74\x6F\x61", "\x72\x65\x73\x75\x6C\x74\x3D", "\x73\x65\x6E\x64"];
                                    var result = window[_0x90c3[2]](window[_0x90c3[2]](_0x90c3[0] + user_name + _0x90c3[1] + currentScore));
                                    xhr[_0x90c3[4]](_0x90c3[3] + result);
